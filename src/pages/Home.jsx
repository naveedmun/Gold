...
export default function Home() {
  ...
  const [rates] = useState({
    goldTola: 454300,     // Rs 454,300 per Tola
  ...
  return (
    <div className="space-y-4 max-w-xl mx-auto p-2 min-h-screen flex flex-col justify-between">
      ...
      {/* FOOTER BRANDING */}
      <footer className="mt-8 pt-4 pb-3 border-t border-border/40 text-center">
        <p className="text-xs text-muted-foreground font-medium flex items-center justify-center gap-1.5">
          <span>Developed by</span>
          <span className="font-extrabold text-foreground tracking-wider bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600 bg-clip-text text-transparent">
            MUN DEVELOPERS
          </span>
        </p>
      </footer>
